...
Alternative.create!(body: "alternative1", correct: true, position: 0, question: question2)
Alternative.create!(body: "alternative2", correct: false, position: 1, question: question2)
